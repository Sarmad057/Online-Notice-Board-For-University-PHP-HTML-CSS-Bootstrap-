...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="images/isb1 (1).jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item">
      <img src="images/lhr_new.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
	 ...
	 <div class="item">
      <img src="images/sahiwal.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
...
<div class="container">
	...
	<!-- container -->
		...
		{
		echo "<h2></h2>
		Welcome to our online notice board system. Ciit is providing this facility so that you can see notification for you from your Boss online. You dont have to go to notice board. Sign Up to enjoy this facility. ";
		}
		?>
  ...
  <div class="panel-body">
    COMSATS has become Univercity now.
  </div>
</div>
...
<!-- footer-->
  ...
  <ul class="nav navbar-nav navbar-left">
    <li><a href="https://www.facebook.com/sarmad.mujahid"> Developed by  Sarmad</a></li>
