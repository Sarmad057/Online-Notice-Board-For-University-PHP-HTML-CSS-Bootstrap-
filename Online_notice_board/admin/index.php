		...
		@$page=  $_GET['page'];
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="../images/Amir_Malik.jpg" width="300" height="242" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>CEO</h4>
              <span class="text-muted">Amir Malik</span></div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="../images/rector.jpg" width="300" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Rector</h4>
              <span class="text-muted">Raheel Qamar</span>
            </div>
